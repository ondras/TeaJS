...
TAGS[0x8769][0xA005] = TAGS; /* exif interopindex -> tiff ifd :) */

/**
 * @param {int[]} buffer Binary data buffer
 */
...
/**
 * Returns all present tags
 * @returns {object}
 */
Reader.prototype.getTags = function() {
	return this._tags;
}

Reader.prototype._scan = function() {
	var offset = 2;
...
Reader.prototype._readTagValue = function(tagStart, tiffStart) {
