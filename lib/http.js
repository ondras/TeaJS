...
ServerResponse = function(output) {
	this._output = output;
...
if (system.env["SERVER_SOFTWARE"]) {
	global.request = new ServerRequest(system.stdin, system.env);
	global.response = new ServerResponse(system.stdout);
}
